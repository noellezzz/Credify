...
const OrganizationPostTable = () => {
  ...
  const handleDeleteEvent = async (eventId) => {
    if (window.confirm('Are you sure you want to delete this event?')) {
      await dispatch(deleteOrganizationEvent(eventId));
    }
  };

  const handlePublishEvent = async (eventId) => {
    await dispatch(publishOrganizationEvent(eventId));
  };
      ...
      <div className="mb-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600">Manage and organize your organization events</p>
          </div>
          <button
...
export default OrganizationPostTable;
