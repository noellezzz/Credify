...
const SchoolPostModal = () => {
  ...
  useEffect(() => {
    if (currentEvent && modalType === 'edit') {
      setFormData({
        ...
        event_type: currentEvent.event_type || 'graduation',
  ...
  const handleSubmit = async (e) => {
    ...
    if (modalType === 'create') {
      await dispatch(createSchoolEvent(formData));
    } else if (modalType === 'edit') {
      await dispatch(updateSchoolEvent({ id: currentEvent.id, eventData: formData }));
    }
  };
...
export default SchoolPostModal; 